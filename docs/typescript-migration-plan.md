...
## 2. Electron Entrypoints (`src/main`, `src/preload`, renderer bootstrap)
...
## 3. Renderer UI (React components & hooks)
...
## 4. Services: Transcription & Formatting Pipelines
...
## 6. Testing Infrastructure & Mocks
